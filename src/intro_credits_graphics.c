...
static const u16 sEthanCredits_Pal[]    = INCBIN_U16("graphics/intro/scene_2/ethan_credits.gbapal");
static const u32 sEthanCredits_Gfx[]    = INCBIN_U32("graphics/intro/scene_2/ethan_credits.4bpp.lz");
...
static const struct SpriteTemplate sSpriteTemplate_Ethan =
{
    .tileTag = TAG_ETHAN,
    .paletteTag = TAG_ETHAN,
    .oam = &sOamData_Player,
    .anims = sAnims_Player,
    .images = NULL,
    .affineAnims = gDummySpriteAffineAnimTable,
...
static const struct SpriteTemplate sSpriteTemplate_EthanBicycle =
{
    .tileTag = TAG_ETHAN,
    .paletteTag = TAG_ETHAN,
...
const struct CompressedSpriteSheet gSpriteSheet_IntroEthan[] =
{
    {
        .data = gIntroEthan_Gfx,
        .size = 0x2000,
        .tag = TAG_ETHAN
    },
    {}
...
{
    { .data = gIntroPlayer_Pal, .tag = TAG_ETHAN },
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsEthan[] =
{
    {
        .data = sEthanCredits_Gfx,
        .size = 0x3800,
        .tag = TAG_ETHAN
    },
    {}
...
{
    { .data = sEthanCredits_Pal, .tag = TAG_ETHAN },
...
const struct CompressedSpriteSheet gSpriteSheet_CreditsRivalEthan[] =
{
    {
        .data = sEthanCredits_Gfx,
        .size = 0x2000,
...
{
    u8 playerSpriteId = CreateSprite(&sSpriteTemplate_Ethan, x, y, 2);
    u8 bicycleSpriteId = CreateSprite(&sSpriteTemplate_EthanBicycle, x, y + 8, 3);
