...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_LYRA_VR] = REMATCH(TRAINER_LYRA_VR_2, TRAINER_LYRA_VR_3, TRAINER_LYRA_VR_4, TRAINER_LYRA_VR_5, TRAINER_LYRA_VR_5, VICTORY_ROAD_1F),
    [REMATCH_BROCK] = REMATCH(TRAINER_BROCK_1, TRAINER_BROCK_2, TRAINER_BROCK_3, TRAINER_BROCK_4, TRAINER_BROCK_5, RUSTBORO_CITY),
    [REMATCH_MISTY] = REMATCH(TRAINER_MISTY_1, TRAINER_MISTY_2, TRAINER_MISTY_3, TRAINER_MISTY_4, TRAINER_MISTY_5, DEWFORD_TOWN),
    [REMATCH_SURGE] = REMATCH(TRAINER_SURGE_1, TRAINER_SURGE_2, TRAINER_SURGE_3, TRAINER_SURGE_4, TRAINER_SURGE_5, MAUVILLE_CITY),
    [REMATCH_ERIKA] = REMATCH(TRAINER_ERIKA_1, TRAINER_ERIKA_2, TRAINER_ERIKA_3, TRAINER_ERIKA_4, TRAINER_ERIKA_5, LAVARIDGE_TOWN),
    ...
    [REMATCH_SABRINA] = REMATCH(TRAINER_SABRINA_1, TRAINER_SABRINA_2, TRAINER_SABRINA_3, TRAINER_SABRINA_4, TRAINER_SABRINA_5, FORTREE_CITY),
    [REMATCH_JANINE] = REMATCH(TRAINER_JANINE_1, TRAINER_JANINE_2, TRAINER_JANINE_3, TRAINER_JANINE_4, TRAINER_JANINE_5, MOSSDEEP_CITY),
    [REMATCH_BLAINE] = REMATCH(TRAINER_BLAINE_1, TRAINER_BLAINE_2, TRAINER_BLAINE_3, TRAINER_BLAINE_4, TRAINER_BLAINE_5, SOOTOPOLIS_CITY),
    [REMATCH_BLUE] = REMATCH(TRAINER_BLUE, TRAINER_BLUE, TRAINER_BLUE, TRAINER_BLUE, TRAINER_BLUE, EVER_GRANDE_CITY),
    [REMATCH_BRUNO] = REMATCH(TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, EVER_GRANDE_CITY),
    [REMATCH_LORELEI] = REMATCH(TRAINER_LORELEI, TRAINER_LORELEI, TRAINER_LORELEI, TRAINER_LORELEI, TRAINER_LORELEI, EVER_GRANDE_CITY),
    [REMATCH_CLAIRE] = REMATCH(TRAINER_CLAIRE, TRAINER_CLAIRE, TRAINER_CLAIRE, TRAINER_CLAIRE, TRAINER_CLAIRE, EVER_GRANDE_CITY),
    [REMATCH_LANCE] = REMATCH(TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, EVER_GRANDE_CITY),
};
...
// Initiates battle where Lyra catches Ralts
void StartLyraTutorialBattle(void)
{
    CreateMaleMon(&gEnemyParty[0], SPECIES_RALTS, 5);
    ScriptContext2_Enable();
    gMain.savedCallback = CB2_ReturnToFieldContinueScriptPlayMapMusic;
    gBattleTypeFlags = BATTLE_TYPE_LYRA_TUTORIAL;
...
static u8 GetTrainerBattleTransition(void)
{
    ...
    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == TRAINER_CLASS_ELITE_FOUR)
    {
        ...
        if (gTrainerBattleOpponent_A == TRAINER_CLAIRE)
            return B_TRANSITION_CLAIRE;
        return B_TRANSITION_CHAMPION;
    }
...
// This applies to the Elite Four and Victory Road Lyra (if he's not been defeated yet)
static bool32 IsRematchForbidden(s32 rematchTableId)
{
    if (rematchTableId >= REMATCH_ELITE_FOUR_ENTRIES)
        return TRUE;
    else if (rematchTableId == REMATCH_LYRA_VR)
        return !FlagGet(FLAG_DEFEATED_LYRA_VICTORY_ROAD);
    else
        return FALSE;
}
