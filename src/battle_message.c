...
static const u8 sText_LyraUsedItem[] = _("LYRA used\n{B_LAST_ITEM}!");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_LYRAUSEDITEM - 12] = sText_LyraUsedItem,
...
const u8 gText_WhatWillLyraDo[] = _("What will\nLYRA do?");
...
const u8 gText_BattleLyraName[] = _("LYRA");
    ...
    *(&gBattleStruct->stringMoveType) = gBattleMsgDataPtr->moveType;
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            ...
            else if (gBattleTypeFlags & BATTLE_TYPE_LYRA_TUTORIAL)
