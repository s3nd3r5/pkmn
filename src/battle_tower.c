...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_ELITE_FOUR_M, FACILITY_CLASS_ELITE_FOUR_BLUE},
    {RS_FACILITY_CLASS_ELITE_FOUR_F, FACILITY_CLASS_ELITE_FOUR_LORELEI},
    {RS_FACILITY_CLASS_LEADER_F, FACILITY_CLASS_LEADER_MISTY},
    {RS_FACILITY_CLASS_LEADER_M, FACILITY_CLASS_LEADER_BROCK},
    {RS_FACILITY_CLASS_LEADER_MF, FACILITY_CLASS_LEADER_JANINE},
    ...
    {RS_FACILITY_CLASS_LYRA, FACILITY_CLASS_LYRA},
    {RS_FACILITY_CLASS_ETHAN_1, FACILITY_CLASS_ETHAN},
    {RS_FACILITY_CLASS_ETHAN_2, FACILITY_CLASS_ETHAN_2},
    {RS_FACILITY_CLASS_ETHAN_3, FACILITY_CLASS_ETHAN_3},
